...
<div class="right_content">
    <!--顶部导航菜单-->
    <br/><div id="header"><span style="border-bottom:2px solid #2D96E9;font-size: 2.5em;font-family:KaiTi_GB2312; font-weight:bold">K米平台服务质量监测系统</span></div><br/>
    <div class="ui tabular menu ">
        <a class="item active">推送量 </a>
        <a class="item" href="/pushServer/index.php/Home/Index/time_delay_info">推送时延 </a>
    ...
    <!--推送量平台占比-->
    <div id="a3">
        <span style="border-bottom:2px solid #2D96E9;font-size: 20px;font-weight:bold">发起推送平台占比</span>

        <div class="ui Inverted divider"></div>
        <div id="forth" style="padding-top:10px; height:400px;"></div>
